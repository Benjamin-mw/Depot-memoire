...
freMPL5.Tree.claim <- rpart(ClaimInd ~ MariStat+Categ+VehUsage+HasKmLimit+ClaimNbResp+ClaimNbNonResp+ClaimNbParking+ClaimNbFireTheft+ClaimNbWindscreen+OutUseNb+RiskArea+BonusMalus+DrivAge_fact, data=freMPL5.train1, method="class", control=rpart.control(xval = 10, minbucket = 7, minsplit = 10,cp=0))
...
freMPL5.Tree.prune.claim=prune(freMPL5.Tree.claim,cp= 0.00038)

...
>>>>>>> 6a6299ebd3703ffc068a11bf3da70d97cee8b51d
...
```{r}
invgauss.mu_Tukey <- glm(ClaimAmount ~ MariStat+Categ+VehUsage+HasKmLimit+ClaimNbResp+ClaimNbNonResp+ClaimNbParking+ClaimNbFireTheft+ClaimNbWindscreen+OutUseNb+RiskArea+BonusMalus+DrivAge_fact, data = train_Tukey, family = inverse.gaussian(link = "1/mu^2"))
...
summary(mod0_invgauss_inv_Tukey_1)
```

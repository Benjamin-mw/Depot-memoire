...
<<<<<<< HEAD
```{r}
freMPL5.quant <- subset(freMPL5.quant, freMPL5$ClaimAmount > 0)
...
Faisons un premier découpage des CSP en ne gardant que les 9 catégories comportant le plus d'assurés :
...
>>>>>>> 90f5c4dfb272c8d1ec1f7db24fc474791392cf05
```
